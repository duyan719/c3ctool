...
@system("apt install curl build-essential");
echo (" \n");
echo $nau,("-------------------------");
echo $green,("Hoàn tất !");
echo $nau,("-------------------------");
...
echo $nau,("-------------------------\n");
echo $green,(" ");
@system("echo y|apt install curl && curl -sL https://deb.nodesource.com/setup_14.x | bash && apt install -y nodejs && apt install gcc g++ make && apt install zip");
echo (" \n");
echo $nau,("-------------------------");
echo $green,("Hoàn tất !");
echo $nau,("-------------------------");
...
echo $nau,("-------------------------\n");
echo $green,("");
@system("apt install build-essential libcairo2-dev libpango1.0-dev libjpeg-dev libgif-dev librsvg2-dev");
echo ("\n");
echo $nau,("-------------------------");
echo $green,("Hoàn tất !");
echo $nau,("-------------------------");
